    ...
    <>
      <section id="about" className="py-16 md:py-32  text-white bg-[#04081A]">
        <div className="mx-auto max-w-5xl px-6 text-center">
          ...
          <TypingAnimation className='text-xl md:text-2xl mt-2'>Fullstack Developer | Software Engineer </TypingAnimation>
        </div>
        <div className="lg:mt-12 md:mt-8 mt-6 mx-auto max-w-5xl space-y-8 px-6 md:space-y-16">
